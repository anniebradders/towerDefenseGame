...
export default class Robot extends Phaser.GameObjects.Image{
    ...
    update(time, delta) {
        ...
        if(time > this.nextTic){
            this.fire();
            this.nextTic = time + 1000 * levelConfig.tank.firerate;
        }
        else {
            this.enemySpeed = levelConfig.tank.speed;
        }
        ...
        }
{
    ...
    startOnPath() {
        ...
        //set health
        this.hp = levelConfig.tank.health;
        //set speed
        this.enemySpeed = levelConfig.tank.speed;
    ...
    fire(){
        ...
        var turretInRange = this.scene.getTurret(this.x, this.y, (50 * levelConfig.tank.range));
