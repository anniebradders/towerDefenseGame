...
export default class Robot extends Phaser.GameObjects.Image{
    ...
    update(time, delta) {
        ...
        if(time > this.nextTic){
            this.fire();
            this.nextTic = time + 1000 * levelConfig.standard.firerate;
        }
        else {
            this.enemySpeed = levelConfig.standard.speed;
        }
        ...
        }
{
    ...
    startOnPath() {
        ...
        //set health
        this.hp = levelConfig.standard.health;
        //set speed
        this.enemySpeed = levelConfig.standard.speed;
    ...
    fire(){
        ...
        var turretInRange = this.scene.getTurret(this.x, this.y, (50 * levelConfig.standard.range));
