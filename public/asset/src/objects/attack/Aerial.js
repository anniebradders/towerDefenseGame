...
export default class Robot extends Phaser.GameObjects.Image{
    ...
    update(time, delta) {
        ...
        if(time > this.nextTic){
            this.fire();
            this.nextTic = time + 1000 * levelConfig.aerial.firerate;
        }
        else {
            this.enemySpeed = levelConfig.aerial.speed;
        }
        ...
        }
{
    ...
    startOnPath() {
        ...
        //set health
        this.hp = levelConfig.aerial.health;
        //set speed
        this.enemySpeed = levelConfig.aerial.speed;
    ...
    fire(){
        ...
        var turretInRange = this.scene.getTurret(this.x, this.y, (50 * levelConfig.aerial.range));
